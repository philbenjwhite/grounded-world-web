      ...
      <Section>
        <Container className="px-[var(--layout-section-padding-x)] max-w-[1200px]">
          ...
          <nav className="mb-8 flex flex-wrap items-center gap-3">
            ...
            {post.category?.name && (
              <span className="inline-flex items-center text-xs font-medium uppercase tracking-wider text-[color:var(--color-cyan)] border border-[var(--color-cyan)]/20 bg-[var(--color-cyan)]/[0.06] rounded-full px-3 py-1">
                {post.category.name}
              </span>
            )}
          </nav>
