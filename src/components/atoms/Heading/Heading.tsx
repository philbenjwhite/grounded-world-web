...
const sizeClasses: Record<HeadingSize, string> = {
  ...
  h1: 'text-[length:var(--font-size-h1)] leading-[1.1] tracking-tight',
  h2: 'text-[length:var(--font-size-h2)] leading-[1.2]',
  h3: 'text-[length:var(--font-size-h3)] leading-[1.25]',
  h4: 'text-[length:var(--font-size-h4)] leading-[1.3]',
};
